...
public class PlayerObjectsLl2 : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject _door1_open1;
    [SerializeField]
    private GameObject _door1_open2;
    [SerializeField]
    private GameObject _door1_open3;
    [SerializeField]
    private GameObject _door2;
    [SerializeField]
    private GameObject _door2_open1;
    [SerializeField]
    ...
    {
        if (other == _key1Coll|| other == _key2Coll || other == _key3Coll || other == _key4Coll)
        {
            if (other == _key1Coll)
            {
                _objectKey = _key1;                
        ...
        if (other == _bomb1Coll || other == _bomb2Coll || other == _bomb3Coll || other == _bomb4Coll)  
        {
            if (other == _bomb1Coll)
                _objectBomb = _bomb1;
            if (other == _bomb2Coll)
        ...
        if (other == _door1_open1.GetComponent<Collider>() || other == _door1_open2.GetComponent<Collider>() || other == _door1_open3.GetComponent<Collider>())
        {
            _IsDoor1InRange = true;
            _objectDoor = _door1;
        }

        if (other == _door2_open1.GetComponent<Collider>())
        {
        ...
        if (other == _door4.GetComponent<Collider>())
        {
            _IsDoor4InRange = true;
            _objectDoor = _door4;
        }
        ...
        if (_gargoyl7 != null && other == _gargoyl7.GetComponent<Collider>())
        {
            _IsGargoylInRange = true;
            _objectGargoyl = _gargoyl7;
        }
    }
    ...
    private void Update()
    {
        ...
        if (_IsSpoonInRange)
        {
            if (Input.GetKeyDown(KeyCode.E) && _objectSpoon.activeInHierarchy)
            {
                ...
                StartCoroutine(PlayerMovmentLl2.AddSpeed());
            }
        }
        if (_IsDoor1InRange)
        {
